// auto-workload=full (n=16384, cores=8, inputs=3, outputs=2, dtype=int32_t)
#include "acl/acl.h"
#include "host.h"
...
int main()
{
    ...
    for (size_t i = 0; i < n; ++i) {
        { h_in0[i] = (i * 7 + 3) % 21 - 10; h_in1[i] = (i * 13 + 1) % 21 - 10; h_in2[i] = (i * 19 + 5) % 21 - 10; }
    }
    ...
    asc_std_spread3_do(8, stream, static_cast<uint8_t*>(d_in0), static_cast<uint8_t*>(d_in1), static_cast<uint8_t*>(d_in2), static_cast<uint8_t*>(d_out0), static_cast<uint8_t*>(d_out1));
