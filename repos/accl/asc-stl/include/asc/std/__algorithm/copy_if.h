#ifndef ASC_STL_INCLUDE_ASC_STD___ALGORITHM_COPY_IF_H_
#define ASC_STL_INCLUDE_ASC_STD___ALGORITHM_COPY_IF_H_
...
#endif // ASC_STL_INCLUDE_ASC_STD___ALGORITHM_COPY_IF_H_
