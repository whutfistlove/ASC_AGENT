...
#include "acl/acl.h"
#include "host.h"
#include "ascend/std/__numeric/lcm.h"
#include <cmath>
#include <cstdlib>
#include <iostream>
#include <vector>
...
int main()
{
    ...
    for (size_t i = 0; i < n; ++i) {
        { h_in0[i] = static_cast<int32_t>((static_cast<int32_t>(i % 19)) - 9); h_in1[i] = static_cast<int32_t>((static_cast<int32_t>((i * 7) % 23)) - 11); }
    }
    ...
    ascend_std_lcm_do(1, stream, static_cast<uint8_t*>(d_in0), static_cast<uint8_t*>(d_in1), static_cast<uint8_t*>(d_out0));
    ...
    for (size_t i = 0; i < n; ++i) {
        ...
        (void)expected;
        (void)expected0;
        { int32_t a0 = x_ref; int32_t b0 = y_ref; if (a0 == 0 || b0 == 0) { expected = 0; } else { int32_t a = a0 < 0 ? -a0 : a0; int32_t b = b0 < 0 ? -b0 : b0; int32_t g0 = a; int32_t g1 = b; while (g1 != 0) { int32_t t = static_cast<int32_t>(g0 % g1); g0 = g1; g1 = t; } expected = static_cast<int32_t>((a / g0) * b); } }
