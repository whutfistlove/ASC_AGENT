...
from core.dep_graph import HeaderDependencyGraphReport
...
from core.inventory import HeaderInventoryReport
from core.migration_status import (
    MigrationStatusReport,
)
from core.test_index import CCCLTestIndexReport
...
def build_migration_context_pack(
    *,
    ...
    return {
        ...
        "include": f"cuda/std/{entry_header}",
        "source_header": {
