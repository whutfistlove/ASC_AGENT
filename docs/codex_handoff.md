...
1. Add a small module that scans real `libcudacxx/include/cuda/std` headers.
2. Add a small module or command that scans real `libcudacxx/test/libcudacxx/std` tests.
