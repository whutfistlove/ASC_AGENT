#ifndef ASC_STL_INCLUDE_ASC_STD___ALGORITHM_MINMAX_H_
#define ASC_STL_INCLUDE_ASC_STD___ALGORITHM_MINMAX_H_
...
_ASC_AICORE_FN constexpr pair<const _Tp&, const _Tp&> minmax(const _Tp& __a, const _Tp& __b) {
    return (__b < __a) ? pair<const _Tp&, const _Tp&>(__b, __a) : pair<const _Tp&, const _Tp&>(__a, __b);
}

template <typename _Tp, typename _Compare>
// NOLINTNEXTLINE
_ASC_AICORE_FN constexpr pair<const _Tp&, const _Tp&> minmax(const _Tp& __a, const _Tp& __b, _Compare __comp) {
    return __comp(__b, __a) ? pair<const _Tp&, const _Tp&>(__b, __a) : pair<const _Tp&, const _Tp&>(__a, __b);
}

_ASC_STD_END

#endif  // ASC_STL_INCLUDE_ASC_STD___ALGORITHM_MINMAX_H_
